...
const About = ({setPlayState}) => {
    // destructuring the setplaystate to use it in the on play icon
  return (
    <div className='about'>
        ...
        <div className='about-right'>
            ...
            <p>
                Whether you aspire to become a teacher, administrator, counselor, or educational leader, our diverse range of programs offers the perfect pathway to acheive your goals and unlock your full potential in shaping the future of education.
            </p>
        </div>
    </div>
  )
